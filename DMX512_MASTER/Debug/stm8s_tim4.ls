 ...
 184  0019 9e            	ld	a,xh
 185  001a c75347        	ld	21319,a
 186                     ; 72   TIM4->ARR = (uint8_t)(TIM4_Period);
 188  001d 9f            	ld	a,xl
 189  001e c75348        	ld	21320,a
 190                     ; 73 }
 193  0021 81            	ret
 ...
 350  0035 9e            	ld	a,xh
 351  0036 ca5343        	or	a,21315
 352  0039 c75343        	ld	21315,a
 354  003c 2009          	jra	L151
 355  003e               L741:
 356                     ; 121     TIM4->IER &= (uint8_t)(~TIM4_IT);
 358  003e 7b01          	ld	a,(OFST+1,sp)
 359  0040 43            	cpl	a
 360  0041 c45343        	and	a,21315
 361  0044 c75343        	ld	21315,a
 362  0047               L151:
 363                     ; 123 }
 366  0047 85            	popw	x
 367  0048 81            	ret
 ...
 673  0073 9e            	ld	a,xh
 674  0074 c75347        	ld	21319,a
 675                     ; 225   TIM4->EGR = (uint8_t)TIM4_PSCReloadMode;
 677  0077 9f            	ld	a,xl
 678  0078 c75345        	ld	21317,a
 679                     ; 226 }
 682  007b 81            	ret
