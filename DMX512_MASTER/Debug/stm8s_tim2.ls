 ...
 479  006b c6530a        	ld	a,21258
 480  006e a4fc          	and	a,#252
 481  0070 c7530a        	ld	21258,a
 ...
 590  009d c6530a        	ld	a,21258
 591  00a0 a4cf          	and	a,#207
 592  00a2 c7530a        	ld	21258,a
 ...
 701  00cf c6530b        	ld	a,21259
 702  00d2 a4fc          	and	a,#252
 703  00d4 c7530b        	ld	21259,a
...
1414  01ca ca5303        	or	a,21251
1415  01cd c75303        	ld	21251,a
1417  01d0 2009          	jra	L545
1418  01d2               L345:
1419                     ; 382     TIM2->IER &= (uint8_t)(~TIM2_IT);
1421  01d2 7b01          	ld	a,(OFST+1,sp)
1422  01d4 43            	cpl	a
1423  01d5 c45303        	and	a,21251
1424  01d8 c75303        	ld	21251,a
1425  01db               L545:
1426                     ; 384 }
1429  01db 85            	popw	x
1430  01dc 81            	ret
...
1815  0211 c65307        	ld	a,21255
1816  0214 a48f          	and	a,#143
1817  0216 1a01          	or	a,(OFST+1,sp)
1818  0218 c75307        	ld	21255,a
1819                     ; 515 }
1822  021b 84            	pop	a
1823  021c 81            	ret
...
1871  021e c65308        	ld	a,21256
1872  0221 a48f          	and	a,#143
1873  0223 1a01          	or	a,(OFST+1,sp)
1874  0225 c75308        	ld	21256,a
1875                     ; 534 }
1878  0228 84            	pop	a
1879  0229 81            	ret
...
1927  022b c65309        	ld	a,21257
1928  022e a48f          	and	a,#143
1929  0230 1a01          	or	a,(OFST+1,sp)
1930  0232 c75309        	ld	21257,a
1931                     ; 553 }
1934  0235 84            	pop	a
1935  0236 81            	ret
...
2963  0341 c65307        	ld	a,21255
2964  0344 a4f3          	and	a,#243
2965  0346 1a01          	or	a,(OFST+1,sp)
2966  0348 c75307        	ld	21255,a
2967                     ; 928 }
2970  034b 84            	pop	a
2971  034c 81            	ret
...
3019  034e c65308        	ld	a,21256
3020  0351 a4f3          	and	a,#243
3021  0353 1a01          	or	a,(OFST+1,sp)
3022  0355 c75308        	ld	21256,a
3023                     ; 948 }
3026  0358 84            	pop	a
3027  0359 81            	ret
...
3075  035b c65309        	ld	a,21257
3076  035e a4f3          	and	a,#243
3077  0360 1a01          	or	a,(OFST+1,sp)
3078  0362 c75309        	ld	21257,a
3079                     ; 968 }
3082  0365 84            	pop	a
3083  0366 81            	ret
...
3707  0419 43            	cpl	a
3708  041a c75304        	ld	21252,a
3709                     ; 1110   TIM2->SR2 = (uint8_t)(~((uint8_t)((uint8_t)TIM2_FLAG >> 8)));
3711  041d 35ff5305      	mov	21253,#255
3712                     ; 1111 }
3715  0421 81            	ret
...
3937  044c 7211530a      	bres	21258,#0
...
3948  045b c65307        	ld	a,21255
3949  045e a40c          	and	a,#12
3950  0460 1a01          	or	a,(OFST+0,sp)
3951  0462 c75307        	ld	21255,a
...
4030  047c 7219530a      	bres	21258,#4
...
4041  048b c65308        	ld	a,21256
4042  048e a40c          	and	a,#12
4043  0490 1a01          	or	a,(OFST+0,sp)
4044  0492 c75308        	ld	21256,a
...
4123  04ac 7211530b      	bres	21259,#0
...
4134  04bb c65309        	ld	a,21257
4135  04be a40c          	and	a,#12
4136  04c0 1a01          	or	a,(OFST+0,sp)
4137  04c2 c75309        	ld	21257,a
