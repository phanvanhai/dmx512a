...
{
	GPIO_Init(GPIOD, LCD_RS, GPIO_MODE_OUT_PP_HIGH_FAST);
...
{                                     
    ...
    LCD_send((display_on | cursor_off | blink_on), CMD); 
